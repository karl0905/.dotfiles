# Generated by Powerlevel10k configuration wizard on 2024-11-25 at 19:25 CET.
...
# 2 lines, dotted, left frame, white-ornaments, sparse, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 64 )) && branch[20,-42]="…"  # <-- this line
